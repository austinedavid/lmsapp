...
const Recents = () => {
  ...
  const lastClassStudents =
    Array.isArray(getClassStudents) && getClassStudents.length > 0
      ? getClassStudents[getClassStudents.length - 1]
      : null;

  return (
    <div className="my-6 flex  md:flex-row justify-between flex-col  text-[15px] gap-3   md:gap-3 rounded-md">
      <div className="flex flex-4 bg-white md:mb-0 mb-6 py-6 px-3  rounded-md overflow-hidden">
        <div className="">
            ...
            <div className="space-y-4 mx-auto mt-4">
              <div className="flex space-x-2">
                ...
                <div className="flex flex-col">
                  <p className="font-bold">
                    {lastClassStudents.name || "Unknown Class name"}
                  </p>
                  <p className="font-semibold pt-2 text-[13px] inline">
                    Subject: {lastClassStudents.subjects || "Unknown Subject"}
                    <Image
                      src={`/${lastClassStudents?.subjects.toLowerCase()}.png`}
                      alt="subject icon"
                      width={50}
                      height={50}
              ...
              <div className="mt-2 flex items-center md:space-x-6 py-3 space-x-4">
                <div className="flex flex-col space-y-2">
                  ...
                  <div className="flex space-x-2">
                    <p className="text-[12px] font-semibold">
                      {handleTime(lastClassStudents.createdAt)}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <div className="flex space-x-2">
                    <p className="text-[12px] font-semibold">
                      {handleDate(lastClassStudents.createdAt)}
                    </p>
                  </div>
                </div>
              </div>
